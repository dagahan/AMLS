...
from src.models.alchemy import EntranceTestSession, Problem, User
...
class EntranceTestService:
    ...
    async def submit_answer(
        ...
        response_payload = await self.response_service.build_response_result(user_id, response_state)
        return EntranceTestAnswerResponse(session=session_response, response=response_payload)
